...
namespace PrettyGit.Interface
{
    internal class Arguments
    {
        ...
        [ValueArgument(typeof(string), "backgroundColor", Description = "Color for the background of the image")]
        ...
        [ValueArgument(typeof(string), "titleColor", Description = "Color of the title for the image.")]
